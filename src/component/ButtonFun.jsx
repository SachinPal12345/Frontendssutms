    ...
    <>
      ...
      <div className='mericlass'>
        ...
        >
          ...
          >
            <h5 style={{
              padding: '10px', margin: 0, marginTop: '-3px'
            }}>Personal Details</h5>
          </div>
          ...
          <Grid container spacing={2} mt="5px">
            ...
            >
              <Form.Group controlId="last exam passing year">
                <Form.Label>
                  <b>Last Exam Passing Year <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Select
                  aria-label="Default select example"
            ...
            >
              <Form.Group controlId="qualifying exam percentage">
                <Form.Label>
                  <b>Qualifying Exam Percentage <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control
                  type="text"
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <Form.Group className="mb-3" controlId="Handicapped">
                <Form.Label>
                  <b>Handicapped  <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Select
                  aria-label="Default select example"
                  name="Handicapped"
            ...
            <Grid item xs={12} md={4}>
              <Form.Group className="mb-3" controlId="Medium">
                ...
                <Form.Select aria-label="Default select example"
                  name="Medium" value={formData1.Medium}
                  onChange={handleChange2}>
            ...
            >
              <Form.Group className="mb-3" controlId="Domicile">
                <Form.Label>
                  <b>Domicile <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Select name="Domicile" value={formData1.Domicile}
                  onChange={handleChange2}>
            ...
            >
              <Form.Group className="mb-3" controlId="ScholarshipRequired">
                <Form.Label>
                  <b>Scholarship Required <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Select name="ScholarshipRequired"
            ...
            >
              <Form.Group className="mb-3" controlId="FathersOccupation">
                <Form.Label>
                  <b>Father's Occupation <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text"
                  name="FathersOccupation" value={formData1.FathersOccupation}
            ...
            >
              <Form.Group className="mb-3" controlId="MothersOccupation">
                <Form.Label>
                  <b>Mother's Occupation <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text"
                  name="MothersOccupation" value={formData1.MothersOccupation}
                  onChange={handleChange2} required />
              </Form.Group>
            </Grid>
            <Grid
            ...
            >
              <Form.Group className="mb-3" controlId="FathersIncome">
                <Form.Label>
                  <b>Father's Income <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text" name="FathersIncome"
            ...
            >
              <Form.Group className="mb-3" controlId="MothersIncome">
                <Form.Label>
                  <b>Mother's Income <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text"
                  name="MothersIncome" value={formData1.MothersIncome}
                  onChange={handleChange2} required />
              </Form.Group>
            </Grid>
            ...
            >
              <Form.Group className="mb-3" controlId="SamagraId">
                <Form.Label>
                  <b>Samagra Id <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text" name="SamagraId"
            ...
            >
              <Form.Group className="mb-3" controlId="ParentMobile">
                <Form.Label>
                  <b>Parent Mobile  <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control type="text"
                  name="ParentMobile" value={formData1.ParentMobile}
                  onChange={handleChange2} required />
              </Form.Group>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={2} mt="5px">
            ...
            <Grid item xs={12} md={6}>
              <Form.Group controlId="address2">
                <Form.Label>
                  <b>Address2  <span style={{ color: 'red' }}> *</span></b>
                </Form.Label>
                <Form.Control
                  type="text"
                  name="address2"
            ...
            <Grid item xs={12} md={6}>
              <Form.Group controlId="country">
                ...
                <Form.Select aria-label="Default select example"
                  name="country" value={formData2.country}
                  onChange={handleChange4}>
                  <option value="">--Select Please--</option>
        ...
        >
          ...
          <Grid container >
            <Grid item xs={12} >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex" }}>
                  <h5>Applicant's Photo  <span style={{ color: 'red' }}> *</span></h5>
                </div>


                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('applicantPhoto', e)}></input>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex" }}>
                  <h5>Applicant's Signature  <span style={{ color: 'red' }}> *</span></h5>
                </div>
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('applicantSignature', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex" }}>
                  <h5>Aadhar Card  <span style={{ color: 'red' }}  > *</span></h5>
                </div>
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange(' aadharCard', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('marksheet10th', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('marksheet12th', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('undergraduateCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('postgraduateCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('domicileCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('transferCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('incomeCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('migrationCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
            ...
            <Grid item xs={12}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex" }}>
                  <input type="file" placeholder="choose"   onChange={(e) => handleFileChange('otherCertificate', e)}></input>
                  <h6 style={{ backgroundColor: " #ffe6e6" }}>Maximum 1000KB</h6>
                </div>
              </div>
              <hr></hr>
